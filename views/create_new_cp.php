...
<table class="mainTable padTable" border="0" cellspacing="0" cellpadding="0">
	...
	<tbody>
	<?=form_open('C=addons_modules'.AMP.'M=show_module_cp'.AMP.'module=fanceebox'.AMP.'method=create_new_cp', 'id="fanceebox"')?>
		<input type="hidden" value="yes" name="allow_create" />
		<input type="hidden" value="1" id="is_cp" name="is_cp" />
		<?php
