...
Add <code>?iframe</code> to the end of your custom links in Zoo Flexible Admin's control panel.

h2. Notes

You can update popup box sizes and settings however, at this time these options will need to be updated manually in the <code>system/expressionengine/third_party/javascript/jquery.fanceebox.js</code> file to meet your specific needs.
